...
from hooks.addon_context import find_addon_context, require_addon_context
...
def post_copy(dest_path: str, content_type_name: str) -> None:
    """
    Post-copy tasks:
    ...
    updater.register_subtemplate("content_types", content_type_name)
    updater.save()
...
def main():
    ...
    if command == "validate":
        ...
        if len(sys.argv) < 4:
            print("Usage: tasks.py post_copy <dest_path> <content_type_name>")
            sys.exit(1)
