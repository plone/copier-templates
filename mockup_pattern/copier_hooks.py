#!/usr/bin/env python3
"""Tasks for the mockup_pattern subtemplate."""
import sys
...
def post_copy(dest_path: str, pattern_name: str) -> None:
    ...
    updater.register_subtemplate("mockup_patterns", pattern_name)
    updater.save()
    print(f"Registered mockup pattern '{pattern_name}' in addon settings.")
